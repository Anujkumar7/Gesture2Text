...
classifier = load_model('C:/Users/kumar/OneDrive/Desktop/Sign-Language-Recognition-Using-Hand-Gestures-Keras-PyQT5-OpenCV-master/Source Code/ASLModel.h5')			#loading the model
...
def fileSearch():
    ...
    fileEntry=[]
    for file in os.listdir("C:/Users/kumar/OneDrive/Desktop/Sign-Language-Recognition-Using-Hand-Gestures-Keras-PyQT5-OpenCV-master/Source Code/SampleGestures"):
...
def toggle_imagesfwd(event):
    ...
    img=load_images_from_folder('C:/Users/kumar/OneDrive/Desktop/Sign-Language-Recognition-Using-Hand-Gestures-Keras-PyQT5-OpenCV-master/Source Code/template.png/')
    global index
...
def openimg():
    ...
    image = cv2.imread('C:/Users/kumar/OneDrive/Desktop/Sign-Language-Recognition-Using-Hand-Gestures-Keras-PyQT5-OpenCV-master/Source Code/template.png')
...
def capture_images(self,cam,saveimg,mask):
    ...
    cam.release()
    cv2.destroyAllWindows()
    if not os.path.exists('C:/Users/kumar/OneDrive/Desktop/Sign-Language-Recognition-Using-Hand-Gestures-Keras-PyQT5-OpenCV-master/Source Code/SampleGestures'):
        os.mkdir('C:/Users/kumar/OneDrive/Desktop/Sign-Language-Recognition-Using-Hand-Gestures-Keras-PyQT5-OpenCV-master/Source Code/SampleGestures')

    gesname=saveimg[-1]
    if(len(gesname)>=1):
        img_name = "C:/Users/kumar/OneDrive/Desktop/Sign-Language-Recognition-Using-Hand-Gestures-Keras-PyQT5-OpenCV-master/Source Code/SampleGestures"+"{}.png".format(str(gesname))
...
def predictor():
    ...
    for i in range(len(fileEntry)):
        image_to_compare = cv2.imread("C:/Users/kumar/OneDrive/Desktop/Sign-Language-Recognition-Using-Hand-Gestures-Keras-PyQT5-OpenCV-master/Source Code/SampleGestures/"+fileEntry[i])
...
class Dashboard(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        uic.loadUi('C:/Users/kumar/OneDrive/Desktop/Sign-Language-Recognition-Using-Hand-Gestures-Keras-PyQT5-OpenCV-master/Source Code/UI_Files/dash.ui', self)
    ...
    def createGest(self):
        ...
        try:
            ...
            pass
        gesname=""
        uic.loadUi('C:/Users/kumar/OneDrive/Desktop/Sign-Language-Recognition-Using-Hand-Gestures-Keras-PyQT5-OpenCV-master/Source Code/UI_Files/create_gest.ui', self)
        self.setWindowTitle(self.title)
        self.create.clicked.connect(self.createGest)
        self.exp2.clicked.connect(self.exportFile)
        ...
        if os.path.exists("C:/Users/kumar/OneDrive/Desktop/Sign-Language-Recognition-Using-Hand-Gestures-Keras-PyQT5-OpenCV-master/Source Code/SampleGestures/"+str(gesname)+".png"):
    ...
    def exportFile(self):
        ...
        try:
            ...
            pass
        uic.loadUi('C:/Users/kumar/OneDrive/Desktop/Sign-Language-Recognition-Using-Hand-Gestures-Keras-PyQT5-OpenCV-master/Source Code/UI_Files/export.UI', self)
        self.setWindowTitle(self.title)
        self.create.clicked.connect(self.createGest)
        self.exp2.clicked.connect(self.exportFile)
        self.scan_sen.clicked.connect(self.scanSent)
    ...
    def scanSent(self):
        ...
        try:
            ...
            pass
        uic.loadUi('C:/Users/kumar/OneDrive/Desktop/Sign-Language-Recognition-Using-Hand-Gestures-Keras-PyQT5-OpenCV-master/Source Code/UI_Files/scan_sent.ui', self)
        self.setWindowTitle(self.title)
        self.create.clicked.connect(self.createGest)
        self.exp2.clicked.connect(self.exportFile)
        if(self.scan_sen.clicked.connect(self.scanSent)):
    ...
    def scanSingle(self):
        ...
        try:
            ...
            pass
        uic.loadUi('C:/Users/kumar/OneDrive/Desktop/Sign-Language-Recognition-Using-Hand-Gestures-Keras-PyQT5-OpenCV-master/Source Code/UI_Files/scan_single.ui', self)
        self.setWindowTitle(self.title)
        self.create.clicked.connect(self.createGest)
        self.exp2.clicked.connect(self.exportFile)
        self.scan_sen.clicked.connect(self.scanSent)
